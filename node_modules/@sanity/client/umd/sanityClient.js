...
},{"is-obj":31}],2:[function(require,module,exports){
...
},{"./GetIntrinsic":3,"./helpers/assertRecord":5,"./helpers/isFinite":6,"./helpers/isNaN":7,"./helpers/mod":8,"./helpers/sign":9,"es-to-primitive/es5":10,"has":29,"is-callable":30}],5:[function(require,module,exports){
...
},{"../GetIntrinsic":3,"has":29}],6:[function(require,module,exports){
...
},{"./helpers/isPrimitive":11,"is-callable":30}],11:[function(require,module,exports){
...
},{"./lib-node":17}],17:[function(require,module,exports){
...
},{"./middleware/defaultOptionsProcessor":18,"./middleware/defaultOptionsValidator":19,"./request":26,"./util/middlewareReducer":28,"nano-pubsub":35}],18:[function(require,module,exports){
...
},{"object-assign":36,"url-parse":72}],19:[function(require,module,exports){
...
},{"is-plain-object":32,"object-assign":36}],21:[function(require,module,exports){
...
},{"object-assign":36}],22:[function(require,module,exports){
...
},{"../util/global":27,"object-assign":36}],23:[function(require,module,exports){
...
},{"./node-progress":23}],25:[function(require,module,exports){
...
},{"parse-headers":39,"same-origin":66}],26:[function(require,module,exports){
"use strict";module.exports=require("./node-request");

},{"./node-request":25}],27:[function(require,module,exports){
(function (global){
...
},{"function-bind":15}],30:[function(require,module,exports){
...
},{"for-each":13,"string.prototype.trim":69}],40:[function(require,module,exports){
...
},{"./config":46,"./symbol/observable":54,"./util/canReportError":58,"./util/pipe":64,"./util/toSubscriber":65}],43:[function(require,module,exports){
...
},{"./config":46,"./util/hostReportError":59}],44:[function(require,module,exports){
...
},{"../internal/symbol/rxSubscriber":55,"./Observer":43,"./Subscription":45,"./config":46,"./util/hostReportError":59,"./util/isFunction":61}],45:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var isArray_1=require("./util/isArray"),isObject_1=require("./util/isObject"),isFunction_1=require("./util/isFunction"),UnsubscriptionError_1=require("./util/UnsubscriptionError"),Subscription=function(){function r(r){this.closed=!1,this._parentOrParents=null,this._subscriptions=null,r&&(this._unsubscribe=r)}var i;return r.prototype.unsubscribe=function(){var i;if(!this.closed){var s=this._parentOrParents,t=this._unsubscribe,n=this._subscriptions;if(this.closed=!0,this._parentOrParents=null,this._subscriptions=null,s instanceof r)s.remove(this);else if(null!==s)for(var e=0;e<s.length;++e){s[e].remove(this)}if(isFunction_1.isFunction(t))try{t.call(this)}catch(r){i=r instanceof UnsubscriptionError_1.UnsubscriptionError?flattenUnsubscriptionErrors(r.errors):[r]}if(isArray_1.isArray(n)){e=-1;for(var o=n.length;++e<o;){var u=n[e];if(isObject_1.isObject(u))try{u.unsubscribe()}catch(r){i=i||[],r instanceof UnsubscriptionError_1.UnsubscriptionError?i=i.concat(flattenUnsubscriptionErrors(r.errors)):i.push(r)}}}if(i)throw new UnsubscriptionError_1.UnsubscriptionError(i)}},r.prototype.add=function(i){var s=i;if(!i)return r.EMPTY;switch(typeof i){case"function":s=new r(i);case"object":if(s===this||s.closed||"function"!=typeof s.unsubscribe)return s;if(this.closed)return s.unsubscribe(),s;if(!(s instanceof r)){var t=s;(s=new r)._subscriptions=[t]}break;default:throw new Error("unrecognized teardown "+i+" added to Subscription.")}var n=s._parentOrParents;if(null===n)s._parentOrParents=this;else if(n instanceof r){if(n===this)return s;s._parentOrParents=[n,this]}else{if(-1!==n.indexOf(this))return s;n.push(this)}var e=this._subscriptions;return null===e?this._subscriptions=[s]:e.push(s),s},r.prototype.remove=function(r){var i=this._subscriptions;if(i){var s=i.indexOf(r);-1!==s&&i.splice(s,1)}},r.EMPTY=((i=new r).closed=!0,i),r}();function flattenUnsubscriptionErrors(r){return r.reduce(function(r,i){return r.concat(i instanceof UnsubscriptionError_1.UnsubscriptionError?i.errors:i)},[])}exports.Subscription=Subscription;

},{"./util/UnsubscriptionError":57,"./util/isArray":60,"./util/isFunction":61,"./util/isObject":62}],46:[function(require,module,exports){
...
},{"../Observable":42}],48:[function(require,module,exports){
...
},{"../Subscriber":44}],49:[function(require,module,exports){
...
},{"../Subscriber":44}],50:[function(require,module,exports){
...
},{"../util/pipe":64,"./defaultIfEmpty":48,"./scan":52,"./takeLast":53}],52:[function(require,module,exports){
...
},{"../Subscriber":44}],53:[function(require,module,exports){
...
},{"../Subscriber":44,"../observable/empty":47,"../util/ArgumentOutOfRangeError":56}],54:[function(require,module,exports){
...
},{"../Subscriber":44}],59:[function(require,module,exports){
...
},{"./noop":63}],65:[function(require,module,exports){
...
},{"../Observer":43,"../Subscriber":44,"../symbol/rxSubscriber":55}],66:[function(require,module,exports){
...
},{"url":67}],67:[function(require,module,exports){
...
},{"es-abstract/es5":4,"function-bind":15}],69:[function(require,module,exports){
...
},{"./implementation":68,"./polyfill":70,"./shim":71,"define-properties":2,"function-bind":15}],70:[function(require,module,exports){
...
},{"./polyfill":70,"define-properties":2}],72:[function(require,module,exports){
(function (global){
...
},{"querystringify":40,"requires-port":41}],73:[function(require,module,exports){
"use strict";function _slicedToArray(e,t){return _arrayWithHoles(e)||_iterableToArrayLimit(e,t)||_nonIterableRest()}function _nonIterableRest(){throw new TypeError("Invalid attempt to destructure non-iterable instance")}function _iterableToArrayLimit(e,t){if(Symbol.iterator in Object(e)||"[object Arguments]"===Object.prototype.toString.call(e)){var r=[],n=!0,i=!1,o=void 0;try{for(var a,s=e[Symbol.iterator]();!(n=(a=s.next()).done)&&(r.push(a.value),!t||r.length!==t);n=!0);}catch(e){i=!0,o=e}finally{try{n||null==s.return||s.return()}finally{if(i)throw o}}return r}}function _arrayWithHoles(e){if(Array.isArray(e))return e}var assign=require("object-assign"),_require=require("@sanity/observable/operators/map"),map=_require.map,_require2=require("@sanity/observable/operators/filter"),filter=_require2.filter,queryString=require("../http/queryString"),validators=require("../validators");function AssetsClient(e){this.client=e}function toDocument(e){var t=e.document;return Object.defineProperty(t,"document",{enumerable:!1,get:function(){return console.warn("The promise returned from client.asset.upload(...) now resolves with the asset document"),t}}),t}function optionsFromFile(e,t){return"undefined"!=typeof window&&t instanceof window.File?assign({filename:!1===e.preserveFilename?void 0:t.name,contentType:t.type},e):e}assign(AssetsClient.prototype,{upload:function(e,t){var r=arguments.length>2&&void 0!==arguments[2]?arguments[2]:{};validators.validateAssetType(e);var n=r.extract||void 0;n&&!n.length&&(n=["none"]);var i=validators.hasDataset(this.client.clientConfig),o="image"===e?"images":"files",a=optionsFromFile(r,t),s=a.label,c=a.title,l=a.description,u=a.creditLine,d=a.filename,f=a.source,m={label:s,title:c,description:l,filename:d,meta:n,creditLine:u};f&&(m.sourceId=f.id,m.sourceName=f.name,m.sourceUrl=f.url);var p=this.client._requestObservable({method:"POST",timeout:a.timeout||0,uri:"/assets/".concat(o,"/").concat(i),headers:a.contentType?{"Content-Type":a.contentType}:{},query:m,body:t});return this.client.isPromiseAPI()?p.pipe(filter(function(e){return"response"===e.type}),map(function(e){return toDocument(e.body)})).toPromise():p},delete:function(e,t){console.warn("client.assets.delete() is deprecated, please use client.delete(<document-id>)");var r=t||"";return/^(image|file)-/.test(r)?e._id&&(r=e._id):r="".concat(e,"-").concat(r),validators.hasDataset(this.client.clientConfig),this.client.delete(r)},getImageUrl:function(e,t){var r=e._ref||e;if("string"!=typeof r)throw new Error("getImageUrl() needs either an object with a _ref, or a string with an asset document ID");if(!/^image-[A-Za-z0-9_]+-\d+x\d+-[a-z]{1,5}$/.test(r))throw new Error('Unsupported asset ID "'.concat(r,'". URL generation only works for auto-generated IDs.'));var n=_slicedToArray(r.split("-"),4),i=n[1],o=n[2],a=n[3];validators.hasDataset(this.client.clientConfig);var s=this.client.clientConfig,c=s.projectId,l=s.dataset,u=t?queryString(t):"";return"https://cdn.sanity.io/images/".concat(c,"/").concat(l,"/").concat(i,"-").concat(o,".").concat(a).concat(u)}}),module.exports=AssetsClient;

},{"../http/queryString":84,"../validators":94,"@sanity/observable/operators/filter":99,"@sanity/observable/operators/map":100,"object-assign":36}],74:[function(require,module,exports){
...
},{"object-assign":36}],75:[function(require,module,exports){
...
},{"../util/getSelection":91,"../validators":94,"deep-assign":1,"object-assign":36}],80:[function(require,module,exports){
...
},{"../validators":94,"./patch":79,"object-assign":36}],81:[function(require,module,exports){
...
},{"../validators":94,"object-assign":36}],82:[function(require,module,exports){
...
},{"make-error":34,"object-assign":36}],84:[function(require,module,exports){
...
},{"./errors":83,"./nodeMiddleware":82,"@sanity/observable/minimal":98,"get-it":16,"get-it/lib/middleware/jsonRequest":20,"get-it/lib/middleware/jsonResponse":21,"get-it/lib/middleware/observable":22,"get-it/lib/middleware/progress":24,"object-assign":36}],86:[function(require,module,exports){
"use strict";var assign=require("object-assign"),projectHeader="X-Sanity-Project-ID";module.exports=function(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{},o={},i=t.token||e.token;i&&(o.Authorization="Bearer ".concat(i)),t.useGlobalApi||e.useProjectHostname||!e.projectId||(o[projectHeader]=e.projectId);var r=Boolean(void 0===t.withCredentials?e.token||e.withCredentials:t.withCredentials),a=void 0===t.timeout?e.timeout:t.timeout;return assign({},t,{headers:assign({},o,t.headers||{}),timeout:void 0===a?3e5:a,json:!0,withCredentials:r})};

},{"object-assign":36}],87:[function(require,module,exports){
...
},{"object-assign":36}],88:[function(require,module,exports){
...
},{"object-assign":36}],90:[function(require,module,exports){
...
},{"eventsource-polyfill/dist/eventsource":12}],96:[function(require,module,exports){
...
},{"../operators/filter":99,"../operators/map":100,"../operators/reduce":101,"object-assign":36,"rxjs/internal/Observable":42}],98:[function(require,module,exports){
module.exports=require("./lib/SanityObservableMinimal");

},{"./lib/SanityObservableMinimal":97}],99:[function(require,module,exports){
exports.filter=require("rxjs/internal/operators/filter").filter;

},{"rxjs/internal/operators/filter":49}],100:[function(require,module,exports){
exports.map=require("rxjs/internal/operators/map").map;

},{"rxjs/internal/operators/map":50}],101:[function(require,module,exports){
exports.reduce=require("rxjs/internal/operators/reduce").reduce;

},{"rxjs/internal/operators/reduce":51}]},{},[88])(88)
});
