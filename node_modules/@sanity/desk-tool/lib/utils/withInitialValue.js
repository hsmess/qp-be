...
var withInitialValue = Pane => {
  var WithInitialValueStream = (0, _reactPropsStream.streamingComponent)(props$ => props$.pipe((0, _operators.switchMap)(props => {
    var options = props.options,
        ...
        paneProps = _objectWithoutProperties(props, ["options", "paneContext"]); // See if the document ID has a draft or a published document
    ...
    (0, _operators.debounceTime)(25), (0, _operators.switchMap)(document => {
      ...
      if (!shouldResolve) {
        ...
        }, _react.default.createElement(Pane, _extends({}, paneProps, {
          options: paneOptions
        }))));
      }
  ...
  var WithInitialValueWrapper = props => _react.default.createElement(_.PaneRouterContext.Consumer, null, context => _react.default.createElement(WithInitialValueStream, _extends({}, props, {
    paneContext: context
  })));
...
function getInitialValueProps(document, props, paneContext) {
  ...
  var parameters = _objectSpread({}, options.templateParameters, {}, payload);
