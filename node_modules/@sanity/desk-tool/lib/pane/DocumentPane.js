...
var _default = (0, _withInitialValue.default)((_temp = _class = class DocumentPane extends _react.default.PureComponent {
  ...
  renderCurrentView() {
    ...
    var _this$state10 = this.state,
        ...
        published = _this$state10.published,
        historical = _this$state10.historical,
        markers = _this$state10.markers,
        isCreatingDraft = _this$state10.isCreatingDraft,
        isUnpublishing = _this$state10.isUnpublishing,
        isPublishing = _this$state10.isPublishing,
        isRestoring = _this$state10.isRestoring,
        isSaving = _this$state10.isSaving,
        validationPending = _this$state10.validationPending,
        isReconnecting = _this$state10.isReconnecting,
        historyState = _this$state10.historyState;
  ...
  render() {
    ...
    var _this$state11 = this.state,
        ...
        transactionResult = _this$state11.transactionResult,
        error = _this$state11.error,
        hasNarrowScreen = _this$state11.hasNarrowScreen,
        isReconnecting = _this$state11.isReconnecting,
        inspect = _this$state11.inspect,
        showConfirmDelete = _this$state11.showConfirmDelete,
        showConfirmUnpublish = _this$state11.showConfirmUnpublish,
        didPublish = _this$state11.didPublish,
