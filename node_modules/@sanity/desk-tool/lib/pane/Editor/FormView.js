...
class FormView extends _react.default.PureComponent {
  ...
  isLiveEditEnabled() {
    var selectedSchemaType = _schema.default.get(this.props.schemaType.name);
  ...
  render() {
    var _this$props = this.props,
        ...
        isReconnecting = _this$props.isReconnecting;
    ...
    if (hasTypeMismatch) {
      ...
      }, "This document is of type ", _react.default.createElement("code", null, value._type), " and cannot be edited as", ' ', _react.default.createElement("code", null, schemaType.name), _react.default.createElement("div", null, _react.default.createElement(_default.default, {
    ...
    return _react.default.createElement("div", {
    ...
    }, history.isOpen ? _react.default.createElement(_HistoryForm.default, {
      document: displayed,
      ...
      published: published,
      readOnly: isReconnecting || !(0, _documentActionUtils.isActionEnabled)(schemaType, 'update'),
      schema: _schema.default,
      type: schemaType
