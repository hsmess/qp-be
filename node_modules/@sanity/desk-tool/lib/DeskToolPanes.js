...
class DeskToolPanes extends _react.default.Component {
  constructor() {
    ...
    _defineProperty(this, "getPaneRouterContext", (0, _index.getPaneRouterContextFactory)(this));
  ...
  renderPanes() {
    ...
    return paneGroups.reduce((components, group, index) => {
      ...
      group.map((sibling, siblingIndex) => {
        ...
        var wrapperKey = pane === _index.LOADING_PANE ? "loading-".concat(i) : "".concat(i, "-").concat(pane.id);
        ...
        var params = isDuplicate ? _objectSpread({}, rootParams, {}, sibling.params) : sibling.params;
        ...
        }, _react.default.createElement(_index.PaneRouterContext.Provider, {
          value: paneRouterContext
        }, pane === _index.LOADING_PANE ? _react.default.createElement(_LoadingPane.default, {
