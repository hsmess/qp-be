...
var _BrokenReferences = _interopRequireDefault(require("./styles/BrokenReferences.css"));
...
function BrokenRefs(props) {
  ...
  }, renderNonExisting && _react.default.createElement(_panePopover.default, {
    icon: true,
    kind: "error",
  ...
  }, nonExistent.map(doc => _react.default.createElement("li", {
    className: _BrokenReferences.default.tagItem,
    key: doc.id
  }, doc.id)))), renderUnpublished && _react.default.createElement(_panePopover.default, {
    icon: true,
    kind: "warning",
  ...
  }, _react.default.createElement(_ReferringDocumentsList.default, {
...
function checkExistance(id) {
  return (0, _rxjs.merge)((0, _preview.observePaths)((0, _draftUtils.getDraftId)(id), ['_type']).pipe((0, _operators.map)(draft => ({
    ...
    published
  })))).pipe((0, _operators.scan)((prev, res) => _objectSpread({}, prev, {}, res), {}), (0, _operators.filter)(res => 'draft' in res && 'published' in res), (0, _operators.map)(res => ({
    id,
