...
var exclusiveParams = ['view'];
exports.exclusiveParams = exclusiveParams;

var PaneRouterContext = _react.default.createContext({
  ...
  ChildLink: (_ref) => {
    var childId = _ref.childId,
        childParameters = _ref.childParameters,
        props = _objectWithoutProperties(_ref, ["childId", "childParameters"]);

    return missingContext();
  },
  // Curried StateLink that passed the correct state, but merges params/payload
  ParameterizedLink: (_ref2) => {
    var params = _ref2.params,
        payload = _ref2.payload,
        props = _objectWithoutProperties(_ref2, ["params", "payload"]);
  ...
  duplicateCurrent: function duplicateCurrent() {
  ...
  navigateIntent: function navigateIntent(intentName, params) {
...
var ChildLink = _react.default.forwardRef(function ChildLink(_ref5, ref) {
  var childId = _ref5.childId,
      childPayload = _ref5.childPayload,
      props = _objectWithoutProperties(_ref5, ["childId", "childPayload"]);
  ...
  var panes = routerPanesState.slice(0, groupIndex + 1).concat([[{
    id: childId,
    payload: childPayload
  }]]);
  return _react.default.createElement(_router.StateLink, _extends({
    ref: ref
  }, props, {
    state: {
      panes
...
var ParameterizedLink = _react.default.forwardRef(function ParameterizedLink(_ref6, ref) {
  var newParams = _ref6.params,
      newPayload = _ref6.payload,
      props = _objectWithoutProperties(_ref6, ["params", "payload"]);
...
function getPaneRouterContextFactory(instance) {
  var contexts = contextCache.get(instance);
  ...
  return (_ref7) => {
    var groupIndex = _ref7.groupIndex,
        siblingIndex = _ref7.siblingIndex,
        flatIndex = _ref7.flatIndex,
        paneParams = _ref7.params,
        panePayload = _ref7.payload;
    ...
    var modifyCurrentGroup = modifier => {
      ...
      var newRouterState = _objectSpread({}, router.state, {
        panes: newPanes
      });
    ...
    var setParams = function setParams(params) {
      ...
      var _DEFAULT_SET_PARAMS_O = _objectSpread({}, DEFAULT_SET_PARAMS_OPTIONS, {}, setOptions),
      ...
      modifyCurrentGroup((siblings, item) => {
        ...
        if (!isDuplicate) {
          newGroup[siblingIndex] = _objectSpread({}, item, {
            params
          });
          return newGroup;
        }
        ...
        if (recurseIfInherited) {
          ...
          var inherited = _objectSpread({}, (0, _omit2.default)(rootParams, removedInheritedKeys), {}, (0, _pick2.default)(params, remainingInheritedKeys));

          newGroup[0] = _objectSpread({}, item, {
            params: inherited
          });
          newGroup[siblingIndex] = _objectSpread({}, item, {
            params: exclusive
    ...
    var ctx = {
      ...
      duplicateCurrent: function duplicateCurrent() {
        ...
        modifyCurrentGroup((siblings, item) => {
          var newGroup = siblings.slice();
          newGroup.splice(siblingIndex + 1, 0, _objectSpread({}, item, {
      ...
      setView: viewId => {
        var view = paneParams.view,
            rest = _objectWithoutProperties(paneParams, ["view"]);

        return setParams(viewId ? _objectSpread({}, rest, {
          view: viewId
        }) : rest);
      },
      // Set the parameters for the current pane
