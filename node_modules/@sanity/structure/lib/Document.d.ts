...
export declare class DocumentBuilder implements Serializable {
    ...
    getChild(): import("./List").List | import("./DocumentList").DocumentList | EditorNode | DocumentNode | import("./Component").Component | import("./List").ListBuilder | import("./DocumentList").DocumentListBuilder | import("./DocumentTypeList").DocumentTypeListBuilder | DocumentBuilder | import("./Component").ComponentBuilder | import("./ChildResolver").ChildResolver | undefined;
