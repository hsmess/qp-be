...
import { DocumentBuilder, PartialDocumentNode, documentFromEditor, documentFromEditorWithInitialValue } from './Document';
...
declare const StructureBuilder: {
    defaults: typeof getDefaultStructure;
    ...
    document: (spec?: PartialDocumentNode | undefined) => DocumentBuilder;
    documentWithInitialValueTemplate: typeof documentFromEditorWithInitialValue;
    ...
    menuItemsFromInitialValueTemplateItems: typeof menuItemsFromInitialValueTemplateItems;
    ...
    editor: typeof documentFromEditor;
    editorWithInitialValueTemplate: typeof documentFromEditorWithInitialValue;
    defaultInitialValueTemplateItems: typeof defaultInitialValueTemplateItems;
    initialValueTemplateItem: (templateId: string, parameters?: {
        [key: string]: any;
    } | undefined) => InitialValueTemplateItemBuilder;
    component: (spec?: Function | ComponentInput | undefined) => ComponentBuilder;
    divider: () => Divider;
    view: typeof views;
};
declare function getDefaultStructure(): ListBuilder;
