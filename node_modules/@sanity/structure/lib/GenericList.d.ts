...
export declare abstract class GenericListBuilder<L extends BuildableGenericList, ConcreteImpl> implements Serializable {
    ...
    getDefaultLayout(): "default" | "card" | "media" | "detail" | "block" | undefined;
    ...
    getChild(): import("./List").List | import("./DocumentList").DocumentList | import("./StructureNodes").EditorNode | import("./StructureNodes").DocumentNode | import("./Component").Component | import("./List").ListBuilder | import("./DocumentList").DocumentListBuilder | import("./DocumentTypeList").DocumentTypeListBuilder | import("./Document").DocumentBuilder | import("./Component").ComponentBuilder | import("./ChildResolver").ChildResolver | undefined;
    ...
    initialValueTemplates(templates: InitialValueTemplateItem | InitialValueTemplateItem[]): ConcreteImpl;
    getInitialValueTemplates(): (InitialValueTemplateItem | InitialValueTemplateItemBuilder)[] | undefined;
