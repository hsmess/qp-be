  ...
  renderBuildStatus() {
    ...
    if (reloadRequired) {
      return _react.default.createElement(_default2.default, {
        ...
        isPersisted: true,
        isCloseable: false,
        title: _react.default.createElement("strong", null, "Reload required!"),
        subtitle: _react.default.createElement("div", null, "To see your latest changes, you need to reload the browser window."),
        action: {
          title: 'Reload',
    ...
    if (buildState === events.EVENT_BUILDING) {
      return _react.default.createElement(_default2.default, {
        ...
        isPersisted: true,
        isCloseable: false,
        title: _react.default.createElement(_spinner.default, {
          inline: true
        }, _react.default.createElement("div", {
          className: _spinnerStyle.default.message
        }, _react.default.createElement("strong", null, "Rebuilding bundle\u2026")))
      });
    }
