...
class HistoryListItem extends _react.default.PureComponent {
  ...
  render() {
    ...
    var availableUsers = users.filter(Boolean);
    var selectionClassName = isSelected ? _ListItemModules.default.selected : _ListItemModules.default.unSelected;

    var content = _react.default.createElement(_react.default.Fragment, null, _react.default.createElement(_EventIcon.default, {
    ...
    }, "Learn about history retention"))), availableUsers && availableUsers.length > 0 && _react.default.createElement(_reactTippy.Tooltip, {
    ...
    }, availableUsers.slice(0, MAX_USERS).map((user, i) => _react.default.createElement("div", {
    ...
    }))))), availableUsers.length === 1 && _react.default.createElement("div", {
      className: _ListItemModules.default.userName
    }, availableUsers[0].displayName), availableUsers.length > 1 && _react.default.createElement("div", {
      className: _ListItemModules.default.extraItems
    }, _react.default.createElement("div", {
      className: _ListItemModules.default.userName
    }, availableUsers.length, " people")))), children && _react.default.createElement("div", {
    ...
    return ParameterizedLink ? _react.default.createElement(ParameterizedLink, _extends({
      params: _objectSpread({}, linkParams, {
        rev: linkRev
      })
    }, rootProps), content) : _react.default.createElement("div", _extends({}, rootProps, {
...
_defineProperty(HistoryListItem, "propTypes", {
  ...
  onArrowUpKey: _propTypes.default.func,
  onArrowDownKey: _propTypes.default.func,
  ...
  linkParams: _propTypes.default.object,
