...
class SnackbarProvider extends _react.default.Component {
  constructor(props, context) {
    ...
    _defineProperty(this, "updateSnack", (snackId, contextSnack) => {
      ...
      if (indexInQueue > -1) {
        this.snackQueue[indexInQueue] = _objectSpread({}, this.snackQueue[indexInQueue], {}, contextSnack);
      } else {
        this.setState((_ref2) => {
          var activeSnacks = _ref2.activeSnacks;
          return {
            activeSnacks: activeSnacks.map(snack => snack.id === snackId ? _objectSpread({}, snack, {}, contextSnack) : snack)
          };
        });
      }
    });
  ...
  */
  ...
  render() {
    ...
    return _react.default.createElement(_react.default.Fragment, null, children, _react.default.createElement(_Portal.Portal, null, _react.default.createElement("div", {
      role: "region",
