...
class ArrayInput extends _react.default.Component {
  constructor() {
    ...
    _defineProperty(this, "renderList", () => {
      ...
      return _react.default.createElement(List, _extends({
        ...
        }, itemProps), _react.default.createElement(_ItemValue.default, {
          type: type,
          value: item,
          level: level,
    ...
    _defineProperty(this, "handleUpload", (_ref) => {
      ...
      this.uploadSubscriptions = _objectSpread({}, this.uploadSubscriptions, {
  ...
  render() {
    ...
    if (hasNonObjectValues) {
      ...
      }, "Some items in this list are not objects. We need to remove them before the list can be edited.", _react.default.createElement("div", {
      ...
      }, "Remove non-object values")), _react.default.createElement(_Details.default, {
        title: _react.default.createElement("b", null, "Why is this happening?")
    ...
    if (hasMissingKeys) {
      ...
      }, "Some items in this list are missing their keys. We need to fix this before the list can be edited.", _react.default.createElement("div", {
        className: _ArrayInput.default.fixMissingKeysButtonWrapper
      }, _react.default.createElement(_default.default, {
        onClick: this.handleFixMissingKeys
      }, "Fix missing keys")), _react.default.createElement(_Details.default, {
        title: _react.default.createElement("b", null, "Why is this happening?")
      }, "This usually happens when items are created through the API client from outside the Content Studio and someone forgets to set the ", _react.default.createElement("code", null, "_key"), "-property of list items.", _react.default.createElement("p", null, "The value of the ", _react.default.createElement("code", null, "_key"), " can be any ", _react.default.createElement("b", null, "string"), " as long as it is", ' ', _react.default.createElement("b", null, "unique"), " for each element within the array."))), this.renderList());
    }
    ...
    return _react.default.createElement(FieldSetComponent, _extends({
      ...
      type: type,
      ref: this.setElement
    }, uploadProps), value && value.length > 0 && this.renderList(), _react.default.createElement(_functions.default, {
      type: type,
      value: value,
      readOnly: readOnly,
